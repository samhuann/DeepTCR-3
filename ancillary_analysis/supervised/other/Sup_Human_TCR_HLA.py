...
DTCR = DeepTCR3_WF('Human_TIL3',device='/device:GPU:3')
DTCR.Get_Data(directory='../../Data/CheckMate_038',Load_Prev_Data=False,
              ...
              hla='../../Data/CheckMate_038/HLA_Ref_sup_AB2.csv')
...
DTCR.Monte_Carlo_CrossVal(folds=folds,LOO=LOO,epochs_min=epochs_min,size_of_net=size_of_net, num_concepts=num_concepts,
                          ...
                          graph_seed=graph_seed,multisample_dropout=True, multisample_dropout_rate=0.50,multisample_dropout_num_masks=64)
